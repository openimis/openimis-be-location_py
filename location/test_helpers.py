...
def create_test_health_facility(code=None, location_id=None, valid=True, custom_props=None):
    if custom_props is None:
        custom_props = {}
    else:
    ...
    if location_id:
        ...
        location_id is None and
        'location' not in custom_props and
        'location_id' not in custom_props
    ):
